...
data <- read.csv('celltype_sample_counts_ImmuneFilter_compact.csv', stringsAsFactors=FALSE, head = TRUE, row.names = 1, check.names = FALSE)
...
save.image(file='consensus_matrix_CRC_ImmuneFilter_compact_clr_temp3.RData')
